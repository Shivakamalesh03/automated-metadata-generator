...
# Optional test runner block (ignored during import)
if __name__ == "__main__":
    filepath = r"sample.docx"  # Example path (update as needed)
    with open(filepath, "rb") as f:
        text = extract_text_from_docx(f)
        metadata = generate_metadata(text, os.path.basename(filepath), "docx")
